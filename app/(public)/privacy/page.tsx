  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-2xl flex-col px-6 py-10">
      ...
      <div className="mt-8 space-y-5 text-[14px] leading-relaxed text-foreground/90">
        <section>
          ...
          <p className="mt-2">
            ...
            enter yourself before each triage, and the conversation between you
            and the AI triage assistant. Clinical baseline details such as blood
            group and genotype are added by you on your profile and are not
        ...
        <section>
          ...
          <p className="mt-2">
            While your triage interview is in progress, the conversation is held
            only on the device you are using, so you can pause and resume
            ...
            generate your clinical summary. We will publish a complete list of
            subprocessors before the system goes into production use.
          </p>
        </section>
        <section>
          <h2 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">
      ...
      <p className="mt-12 text-xs text-muted-foreground">
        This page is a placeholder for the prototype. The production notice will
        replace it before the system is used with real patient data.
      </p>
    </div>
  );
}
